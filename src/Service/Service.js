...
export async function getCart() {
  return fetch("http://54.158.80.18:8000/cartDry85").then((response) =>
    response.json()
  );
}
...
export async function addCart(SKU) {
  ...
  return fetch("http://54.158.80.18:8000/cartDry85", {
    method: "POST",
...
export async function checkCart() {
  return fetch("http://54.158.80.18:8000/cartDry85/checkout", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
  }).then((response) => response.json());
}
